...
const AdministrativePage = () => {
  ...
  return (
    <div className="w-full flex items-center justify-center gap-10 pt-5 min-h-[88.9vh] bg-zinc-100 font-teko">
      <div
        className="w-full max-w-7xl min-h-[80vh] bg-white flex p-5 flex-col items-center justify-center"
        id="formContainer"
      >
        <div className="w-full min-h-full flex flex-col gap-5 items-center justify-center">
          ...
          <div className="w-full flex items-center justify-center gap-10">
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                <label htmlFor="dialogue6">Background:</label>
                <textarea
                  id="dialogue6"
                  className="bg-zinc-100 rounded-md p-2 w-full"
                  name="dialogue6"
              ...
              <div className="flex gap-5">
                ...
                <div className="flex gap-5">
                  <label>
                    <input type="radio" name="doa" value="Yes" checked /> Yes
                  </label>
                  <label>
                    <input type="radio" name="doa" value="No" /> No
                  </label>
                </div>
              </div>

              <div className="flex flex-col gap-4">
                <label htmlFor="dialogue9">Effective Authority:</label>
                <textarea
                  className="bg-zinc-100 rounded-md p-2 w-full"
                  id="dialogue9"
                  name="dialogue9"
