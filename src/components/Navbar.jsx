    ...
    <div className='w-full h-20 font-teko bg-white shadow-md'>
      <div className='w-full h-full flex items-center justify-between px-4 md:px-8'>
        ...
        <div className='flex-1 text-center'>
            <h1 className='text-xl md:text-2xl lg:text-[2.5rem] font-bold'>TENDER DOCUMENT MANAGEMENT SYSTEM</h1>
        </div>
        <div className='flex items-center justify-center gap-3 md:gap-5 text-[0.9rem] md:text-[1.2rem]'>
            ...
            <button onClick={handleLogout} className='bg-orange-500 text-white rounded-md px-2 py-1 md:px-3 md:py-1'>Logout</button>
        </div>
      </div>
    </div>
  )
